...
* Uso de linguagem ou imagens sexualizadas e investidas ou avanços sexuais de
  qualquer tipo
* Comentários provocativos (_trolling_), insultuosos ou depreciativos e ataques
...
justas em resposta a qualquer comportamento que considerem impróprio,
ameaçador, ofensivo ou prejudicial.

Os líderes da comunidade têm o direito e a responsabilidade de remover, editar
ou rejeitar comentários, _commits_, código, edições de _wiki_, _issues_ e
...
Este Código de Conduta se aplica a todos os espaços da comunidade e também
quando um indivíduo estiver representando oficialmente a comunidade em espaços
públicos.

## Aplicação

Casos de comportamento abusivo, de assédio ou de outra forma inaceitável podem
ser reportados aos líderes da comunidade responsáveis pela aplicação, abrindo
uma _issue_ no repositório do projeto no GitHub ou entrando em contato
diretamente com os mantenedores pelos canais de contato do GitHub. Todas as
reclamações serão analisadas e investigadas de forma rápida e justa.
...
para determinar as consequências de qualquer ação que considerem violação deste
Código de Conduta:
...
solicitada com quem aplica o Código de Conduta, por um período determinado.
Isso inclui evitar interações em espaços da comunidade e em canais externos
como redes sociais. Violar esses termos pode levar a um banimento temporário ou
permanente.
...
interação pública ou privada com as pessoas envolvidas é permitida durante
esse período. Violar esses termos pode levar a um banimento permanente.

### 4. Banimento permanente

**Impacto na comunidade**: Demonstração de um padrão de violação dos padrões da
comunidade, incluindo comportamento inadequado contínuo, assédio a um
indivíduo ou agressão ou depreciação de grupos de pessoas.
...
FAQ em https://www.contributor-covenant.org/faq. Traduções estão disponíveis
